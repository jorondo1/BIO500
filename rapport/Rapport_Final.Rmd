...
#library(pacman)
#p_load(igraph, dplyr, GGally,ggpubr, gridExtra, intergraph, knitr, magrittr,
#       patchwork, network, NetworkToolbox, RColorBrewer, rstatix, sparsebnUtils, 
#       sna, spaa, tibble, tidygraph, visNetwork, wordcountaddin)
```
