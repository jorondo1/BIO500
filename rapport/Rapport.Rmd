...
Les caractéristiques du réseau mesurées sont rapportées dans le Tableau \@ref(tab:info). 

</div>

```{R info, tab.cap="Caractéristiques générales du réseau global et du sous-réseau du noyau des étudiants de la classe.", echo=FALSE}
...
```{R reseauannee, fig.cap="Visualisation du réseau en fonction de l'année de début.", message=FALSE, warning=FALSE, echo=FALSE}
